...
Gate::Gate(QGraphicsScene *scene, QGraphicsItem *parent) : ObstacleBase(scene, parent), m_greenBrush(Qt::green)
{
...
void Gate::mouseReleaseEvent(QGraphicsSceneMouseEvent *event)
{
    ...
    ObstacleBase::mouseReleaseEvent(event);
